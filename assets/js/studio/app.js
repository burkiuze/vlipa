...
async function panel() {
  ...
  // The menu asked for the groups a moment ago; this is the same request, and
  // the cache hands back the same answer rather than making it twice.
...
async function render() {
  ...
  if (item.id !== 'meetings') meet.leave();
